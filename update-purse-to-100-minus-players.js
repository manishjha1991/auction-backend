...
const updatePurseTo100MinusPlayers = async () => {
  try {
    ...
    console.log('PURSE UPDATE PREVIEW (DRY RUN)');
    console.log('='.repeat(100));
    ...
    // For now, just show the preview. In a real implementation, you would add:
    ...
    //       console.log(`✅ Updated ${op.teamName}: ${op.currentPurse} → ${op.newPurse}`);
    //     } catch (error) {
    //       console.error(`❌ Failed to update ${op.teamName}:`, error.message);
    //     }
    //   }
    //   
    //   console.log('\n🎉 All purse values updated successfully!');
    // } else {
    //   console.log('\n❌ Update cancelled by user.');
    // }
    
    console.log('\n📝 To actually perform the update, uncomment the confirmation code in the script.');
